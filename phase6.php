...
<section class="metrics-grid compact" aria-label="Grow and preserve summary">
    <?php if ($canViewGarden): ?><article class="metric-card"><div><p>Garden zones</p><strong><?= count($zones) ?></strong></div></article>
    <article class="metric-card"><div><p>Active plantings</p><strong><?= $activePlantings ?></strong></div></article>
    <article class="metric-card"><div><p>Harvest ready</p><strong><?= $harvestReady ?></strong></div></article><?php endif; ?>
    <?php if ($canViewPreservation): ?><article class="metric-card"><div><p>Stored batches</p><strong><?= $storedPreservation ?></strong></div></article><?php endif; ?>
</section>
...
<section class="content-grid">
    ...
    <?php if ($canViewPreservation): ?><article class="panel">
